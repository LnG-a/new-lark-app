...
import { ReactComponent as AscActiveIcon } from "assets/img/newlark/asc-active.svg";
import { ReactComponent as AscIcon } from "assets/img/newlark/asc.svg";
import { ReactComponent as CollapseIcon } from "assets/img/newlark/collapse.svg";
import { ReactComponent as DscActiveIcon } from "assets/img/newlark/dsc-active.svg";
import { ReactComponent as DscIcon } from "assets/img/newlark/dsc.svg";
                ...
                >
                  <div className={styles.cellContainer}>
                    <div
                      ...
                      onClick={() =>
                        onRequestOrder(column.key, column.sortable)
                      }
                    >
                      {column.label}
                      ...
                      {canSort ? (
                        sorting ? (
                          <Sort activeMethod={orderDirection} />
                        ) : (
                          <Sort />
                        )
                      ) : null}
