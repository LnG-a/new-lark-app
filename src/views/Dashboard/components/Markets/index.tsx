...
const Markets: FC = () => {
  ...
  const userSupplied = useMemo(
    () => Boolean(suppliedAssets.length),
    [suppliedAssets]
  );
  const userBorrowed = useMemo(
    () => Boolean(borrowingAssets.length),
    [borrowingAssets]
  );
    ...
    <>
      <div className={styles.markets}>
        <div className={styles.market}>
          {userSupplied && (
            <SupplyingMarketsTable supplyAssets={suppliedAssets} />
          )}
          <SupplyMarketsTable supplyAssets={supplyMarketAssets} />
        </div>
        <div className={styles.market}>
          {userBorrowed && (
            <BorrowingMarketsTable borrowAssets={borrowingAssets} />
          )}
      ...
      {/* <div className={styles.marktsList}>
        ...
        {userBorrowed && (
          <BorrowingMarketsList borrowAssets={borrowingAssets} />
        )}
