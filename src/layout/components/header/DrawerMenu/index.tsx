...
import { ReactComponent as CloseIcon } from "assets/img/newlark/close.svg";
import { ReactComponent as ToDark } from "assets/img/newlark/dark.svg";
import { ReactComponent as ToLight } from "assets/img/newlark/light.svg";
import { ReactComponent as MenuTrigger } from "assets/img/newlark/menu-trigger.svg";
      ...
      <Drawer anchor="right" open={open} onClose={() => setOpen(false)}>
        <div className={styles.drawerMenu}>
          ...
          <div className={styles.themeSwitcher} onClick={toggleTheme}>
            {isDark ? (
              <ToLight width={24} height={24} />
            ) : (
              <ToDark width={24} height={24} />
            )}
          </div>
        </div>
      </Drawer>
